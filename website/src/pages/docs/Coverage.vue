<template>
  <article class="km-doc">
    ...
    <p class="km-mono km-covnote">
      ...
      <code>conformance-platforms.json</code> — never hand-edited, so they can't drift from the last run.
      Shown here for the primary platform; the
      <router-link to="/conformance" class="km-link">conformance page</router-link> tabs across every OS.
    </p>
...
/* The external-conformance headline row carries all four public suites — a
   single balanced row that collapses 4 → 2 → 1 rather than orphaning a card.
   (The per-suite --lanes blocks below re-set 2 columns; that rule comes later.) */
.km-headline--conf { margin-top: 4px; grid-template-columns: repeat(4, 1fr); }
@media (max-width: 820px) { .km-headline--conf { grid-template-columns: repeat(2, 1fr); } }
