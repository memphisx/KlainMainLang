...
3957 files total: **46 passed**, 2540 failed, 1371 skipped (out of scope).

Of the 2586 files that compiled far enough to run, **46 passed (1.8%)**.

## By suite

| Suite | Passed | Failed | Skipped | Total |
|---|---|---|---|---|
| parallel | 43 | 2429 | 1071 | 3543 |
| sequential | 0 | 31 | 90 | 121 |
| es-module | 1 | 58 | 116 | 175 |
| message | 1 | 8 | 2 | 11 |
| internet | 1 | 14 | 23 | 38 |
| pummel | 0 | 0 | 52 | 52 |
...
| 41 | COMPILE_ERROR: this usage of the built-in '%s' module is not supported |
| 40 | COMPILE_ERROR: undefined function or closure '%s' |
| 37 | RUNTIME_NONZERO_EXIT:  |
...
| 11 | COMPILE_ERROR: child_process.fork supports self-fork only — the path must be __filename or process… |
| 11 | COMPILE_ERROR: http has no method '%s' |
| 10 | COMPILE_ERROR: an Http2Stream supports .respond(headers), .write(chunk), .end(chunk?), .on('%s'|'%s'… |
