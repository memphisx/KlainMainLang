...
*Last updated: 2026-08-12 — Function expressions (V1: anonymous only) shipped, plus the duplicate-parameter-name and strict-mode-parameter early-error checks that fixed the conformance regressions shipping it exposed — see [ADR-00168](../adr/ADR-00168.md).*
