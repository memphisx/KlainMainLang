...
| language | 4969 | 23724 | 20.9% | Core language: statements, expressions, literals, classes, modules, ASI, scoping — the in-scope engine. |
...
| 619 | `this` | `built-ins/Array/from/Array.from_forwards-length-for-array-likes.js` |
