...
| [00253](ADR-00253.md) | Async generators (`async function*`) and `for await...of` | Implements [TDD-00085](../tdd/TDD-00085.md) (Stages 2–3); builds on [ADR-00172](ADR-00172.md), [ADR-00244](ADR-00244.md), [ADR-00249](ADR-00249.md) |
| [00254](ADR-00254.md) | Async generator methods (`async *m()`) | Implements [TDD-00085](../tdd/TDD-00085.md) (Stage 4, completing it); builds on [ADR-00253](ADR-00253.md), [ADR-00182](ADR-00182.md) |
| [00255](ADR-00255.md) | A `.catch`/onRejected callback's error parameter is the error object | Refines [ADR-00248](ADR-00248.md); uses the arrow param-hint path from [ADR-00245](ADR-00245.md) |
| [00256](ADR-00256.md) | Rest parameters in a genuinely-suspending async function | Refines [ADR-00249](ADR-00249.md) / TDD-00084 Part C; reuses the array-param bundle path |
| [00257](ADR-00257.md) | Destructuring loop variable in `for await...of` (and over sync generators), plus tuple/object `yield` | Refines [ADR-00253](ADR-00253.md), [ADR-00192](ADR-00192.md), [TDD-00085](../tdd/TDD-00085.md); reuses the `unpack*PatternInto` core |
| [00258](ADR-00258.md) | `.then`/`.catch`/`.finally` directly on a raw fetch `Promise<Response>` | Extends [ADR-00248](ADR-00248.md); builds on the fetch-await path and `buildResponseFromStatusBody` |
| [00259](ADR-00259.md) | Generator protocol completion — `.throw()`, `.return()`, `yield*` | Implements [TDD-00086](../tdd/TDD-00086.md); builds on [ADR-00172](ADR-00172.md), [ADR-00244](ADR-00244.md) |
| [00260](ADR-00260.md) | `.throw()` / `.return()` on async generators (unified generator swap) | Extends [ADR-00259](ADR-00259.md) to async generators; builds on [ADR-00253](ADR-00253.md), [ADR-00244](ADR-00244.md) |
| [00261](ADR-00261.md) | `yield*` delegation over an async generator | Extends [ADR-00259](ADR-00259.md), [ADR-00260](ADR-00260.md); part of [TDD-00086](../tdd/TDD-00086.md) |
| [00262](ADR-00262.md) | `Promise.resolve` / `Promise.reject`, and awaiting a `.then`/`.catch` chain | Builds on [ADR-00248](ADR-00248.md), [ADR-00249](ADR-00249.md); fixes a lightweight-await use-after-free |
| [00263](ADR-00263.md) | `new Promise((resolve, reject) => …)` — the executor constructor | Implements [TDD-00087](../tdd/TDD-00087.md); builds on [ADR-00249](ADR-00249.md), [ADR-00248](ADR-00248.md), [ADR-00262](ADR-00262.md) |
| [00264](ADR-00264.md) | `Promise.reject` is `Promise<never>` (a bottom type) | Refines [ADR-00262](ADR-00262.md); closes that row's only caveat |
| [00265](ADR-00265.md) | Unify async-method promises with async functions; declared `Promise<T>` await; async-return flattening | Refines [ADR-00249](ADR-00249.md); closes the promise-representation caveats |
| [00266](ADR-00266.md) | Event-driven waiter list for `Promise.race`/`.any` over tasks; `new Promise<void>` | Refines [ADR-00073](ADR-00073.md)/[TDD-00083](../tdd/TDD-00083.md); closes the `.race` busy-poll caveat |
| [00267](ADR-00267.md) | `new Promise` executor may be a function expression or closure-typed value | Refines [ADR-00263](ADR-00263.md) |
| [00268](ADR-00268.md) | Microtask-accurate `await` ordering — every `await` yields a tick | Implements [TDD-00088](../tdd/TDD-00088.md); refines [ADR-00249](ADR-00249.md) |
| [00269](ADR-00269.md) | `Symbol.asyncIterator` — user-defined async iterables in `for await...of` | Implements [TDD-00089](../tdd/TDD-00089.md); extends [ADR-00253](ADR-00253.md), [ADR-00254](ADR-00254.md) |
| [00270](ADR-00270.md) | A Promise is a reusable value — `await`/combinators stop consuming the slot | Implements [TDD-00090](../tdd/TDD-00090.md); refines [ADR-00249](ADR-00249.md), [ADR-00073](ADR-00073.md); corrects the `await` strict claim |
| [00271](ADR-00271.md) | Thenable adoption — `resolve(aPromise)` in a `new Promise` executor | Implements [TDD-00091](../tdd/TDD-00091.md); extends [ADR-00263](ADR-00263.md), [ADR-00267](ADR-00267.md) |
| [00272](ADR-00272.md) | `for await...of` over a sync array; generic-type array-suffix parse fix | Implements [TDD-00092](../tdd/TDD-00092.md); extends [ADR-00253](ADR-00253.md), [ADR-00269](ADR-00269.md) |
| [00273](ADR-00273.md) | Module-level variables — a named `function` can read a top-level `const`/`let` | Implements [TDD-00093](../tdd/TDD-00093.md); relates to [ADR-00001](ADR-00001.md) |
| [00274](ADR-00274.md) | Nested generators (by-ref capture), async `yield*` over an async iterable, nested-function resolver fix | Implements [TDD-00094](../tdd/TDD-00094.md) stages 1–3; reuses [ADR-00001](ADR-00001.md), [ADR-00269](ADR-00269.md) |
| [00275](ADR-00275.md) | Async generator `.next()` is a genuinely-pending promise (deferred body) — settle-without-drain deadlock fixed; `yield*`-async-iterable `.throw`/`.return` swallow fix | Completes [TDD-00094](../tdd/TDD-00094.md) stage 4; supersedes [ADR-00274](ADR-00274.md)'s reverted deferral |
| [00276](ADR-00276.md) | `yield*` delegates `.throw`/`.return` into a user async-iterable's optional methods; reserved words valid as class member names | Closes [TDD-00094](../tdd/TDD-00094.md)'s last caveat (async-generators row → strict) |
| [00277](ADR-00277.md) | `for await...of` over sync generators, `Map`/`Set`, and arrays of raw fetches | Extends [ADR-00272](ADR-00272.md), [ADR-00270](ADR-00270.md) |
| [00278](ADR-00278.md) | Sync `[Symbol.iterator]()` protocol for `for...of` and `for await...of` | Extends [ADR-00269](ADR-00269.md), [ADR-00063](ADR-00063.md) |
| [00279](ADR-00279.md) | Object-literal `[Symbol.asyncIterator]` as a `for await` iterable | Extends [ADR-00269](ADR-00269.md), [ADR-00277](ADR-00277.md) |
| [00280](ADR-00280.md) | Deferred (non-blocking) drive for `.then` on a raw fetch `Promise<Response>` | Supersedes [ADR-00258](ADR-00258.md)'s synchronous drive |
