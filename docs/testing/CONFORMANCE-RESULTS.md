...
| built-ins | 414 | 23812 | 1.7% | Standard library objects (Array, Object, String, Math, RegExp, Promise, TypedArrays, …) — many probe the dynamic object model. |
...
| language | 4728 | 23724 | 19.9% | Core language: statements, expressions, literals, classes, modules, ASI, scoping — the in-scope engine. |
...
| 46825 | compile (front-end parse/resolve/codegen) |
| 7 | runtime (timeout) |
...
| 5275 | compile | COMPILE_ERROR: only simple function calls are supported | `annexB/built-ins/Date/prototype/getYear/nan.js` |
| 4792 | compile | COMPILE_ERROR: undefined variable '%s' | `annexB/built-ins/Date/prototype/getYear/this-not-date.js` |
| 4757 | compile | COMPILE_ERROR: undefined function or closure '%s' | `annexB/built-ins/Date/prototype/getYear/B.2.4.js` |
...
| 1746 | compile | COMPILE_ERROR: unknown class '%s' | `built-ins/AggregateError/message-undefined-no-prop.js` |
| 1476 | compile | COMPILE_ERROR: unexpected character '%s' | `built-ins/Function/prototype/toString/unicode.js` |
| 706 | compile | COMPILE_ERROR: field access on non-object (no field '%s') | `built-ins/ArrayBuffer/prototype/maxByteLength/return-maxbytelength-non-resizable.js` |
...
| 536 | compile | COMPILE_ERROR: '%s' is only valid inside a method or constructor body | `built-ins/Array/from/Array.from_forwards-length-for-array-likes.js` |
...
| 184 | compile | COMPILE_ERROR: cannot convert type ptr to string in template literal | `built-ins/Array/prototype/reverse/S15.4.4.8_A1_T2.js` |
